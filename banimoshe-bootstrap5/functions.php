...
#Defining a constant to avoid naming the directory over and over again...
...
function cwt_bootstrap5_enqueue_scripts() {
    ...
    wp_enqueue_style( 'stylesheet_cwtb5' , get_template_directory_uri() . '/assets/style.css' , ['bootstrap5_styles'] , filemtime( CWTB5_DIR_PATH . '/assets/style.css' ) , 'all' );
    ...
    #QUICK NOTE:
        ...
        #wp_register_style( 'style_cwtb5' , get_template_directory_uri() . '/assets/style.css' , [] , filemtime( CWTB5_DIR_PATH . '/assets/style.css' ) , 'all' );
        #if ( $condition ) {
    ...
    wp_enqueue_script( 'main_script_cwtb5' , get_template_directory_uri() . '/assets/main.js' , [ 'bootstrap5_min_js' ] , filemtime( CWTB5_DIR_PATH . '/assets/main.js' ) , 'false' );
